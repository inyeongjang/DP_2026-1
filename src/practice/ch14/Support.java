...
public abstract class Support {
    ...
    private Support next;   // 떠넘길 곳 (Suppot : 부모 타입 -> 모든 종류의 해결자들을 가리킬 수 있다.)
    ...
    public void support(Trouble trouble) {
        ...
        } else if (next != null) { // 내가 해결 못 하고 뒷 사람이 있으면 
            next.support(trouble); // 뒷 사람에게 떠넘김 
        } else { // 내가 해결 못 하고 뒷 사람도 없으면
